...
// Live data context — populated by the main F8TributoReport component
...
function IntelBar() {
  const { cars: CARS_BY_RANK } = useReportData();
...
function PredictionsSection() {
  ...
  const car = CARS_BY_RANK.find((c) => c.id === selectedId) ?? activeCarsForPred[0]!;
