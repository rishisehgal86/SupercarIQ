/**
 * Ferrari 488 Pista — UK Investment Analysis
 * 
 ...
 * 
 * Layout mirrors the 812 Superfast report page for consistency.
 */
...
const MODEL_KEY = "488-pista";
const MODEL_LABEL = "Ferrari 488 Pista";
const YEAR_RANGE = "2018–2020";
const ENGINE_SPEC = "3.9L Twin-Turbo V8 · 720hp · 568lb-ft";
const HERO_IMAGE = "/manus-storage/488-pista-hero_94e5d086.jpg";
...
function EmailGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onUnlock();
      toast.success("Access granted — welcome to the 488 Pista analysis.");
    } catch (err) {
        ...
        <div className="relative container pb-10 pt-28 md:pb-16">
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl font-black text-foreground leading-tight mb-4">
              Ferrari 488<br />
              <span className="text-primary italic">Pista</span>
            </h1>
            <p className="text-base md:text-lg text-foreground/70 max-w-xl mb-6 font-light">
              {ENGINE_SPEC}
            </p>
          </div>
        </div>
        ...
        <div className="container max-w-2xl">
          <div className="bg-card border border-border p-8 md:p-12">
            ...
            <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
              Enter your email to access the complete Ferrari 488 Pista UK investment analysis — 
...
function PistaReport() {
  ...
  const { data: listings, isLoading: listingsLoading } = (trpc as any).listings?.byModel?.useQuery?.({ modelKey: MODEL_KEY }) ?? { data: null, isLoading: false };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border mb-4">
              {[
                ...
                { label: "Engine", value: "V8 TT 720hp" },
              ].map((stat) => (
      ...
      {/* Investment Analysis — LLM Content */}
      {isLoading ? (
            ...
            <section className="py-20 border-t border-border">
              <div className="container text-center">
                ...
                <p className="text-muted-foreground max-w-md mx-auto mb-8 text-sm">
                  Our LLM pipeline is generating the complete 488 Pista investment analysis. 
...
// ── Page entry point ──────────────────────────────────────────────────────────
export default function Ferrari488PistaReport() {
