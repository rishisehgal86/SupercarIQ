...
import { CARS_458_BY_RANK as CARS_BY_RANK, CARS_458 as CARS, CARS_458_MARKET_STATS as MARKET_STATS } from "@/data/ferrari458";
...
function PredictionsSection() {
  ...
  const car = CARS.find((c) => String(c.id) === selectedId) ?? activeCarsForPred[0]!;
